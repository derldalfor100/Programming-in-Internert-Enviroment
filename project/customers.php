...
@mysql_select_db($database) or die( "Unable to select database");
  ...
  $query = "SELECT userid, FirstName, LastName, UserName FROM people";
            ...
            <table class="striped">
                ...
                <tbody>
                    <?php 
                        for ($i=0;$i<$num;$i++) {
                            echo "<tr>\n";
                            echo "  <td>" . mysql_result($res,$i,'userid') . "</td>\n";
                            echo "  <td>" . mysql_result($res,$i,'FirstName') . "</td>\n";
                            echo "  <td>" . mysql_result($res,$i,'LastName') . "</td>\n";
                            echo "  <td>" . mysql_result($res,$i,'UserName') . "</td>\n";
                            echo "</tr>\n";
                        }
                    ?>
                </tbody>
